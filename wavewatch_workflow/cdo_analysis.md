...
Expression file (wind_exprf.txt)
...
## Wind–current interaction metrics
Purpose

Compute: wind speed, current speed, wind direction, current direction, angle between wind and current

Expression file (wnd_cur_exprf.txt)
